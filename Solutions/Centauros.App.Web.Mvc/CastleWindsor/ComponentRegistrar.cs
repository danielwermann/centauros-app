...
namespace Centauros.App.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Centauros.App.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Centauros.App.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("Centauros.App.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("Centauros.App.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Centauros.App.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("Centauros.App.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
